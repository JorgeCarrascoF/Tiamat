...
const TurnSelectorPage = () => {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.title}>TurnSelectorPage</Text>
            ...
            <Pressable
                ...
                style={[styles.button, players.length == 0 && textPlayers == '' && { backgroundColor: 'grey' }]}
            >
                <Text style={styles.buttonText}>Choose first turn!</Text>
            </Pressable>
            {firstTurn != '' && <Text style={styles.firstTurn}>First turn goes to {firstTurn}!</Text>}
        </View>
    )
}
