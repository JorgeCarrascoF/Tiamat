import { Pressable, ScrollView, ScrollViewBase, StyleSheet, Text, View } from "react-native";
        ...
        <View style={styles.container}>
            ...
            <View style={{ paddingBottom: 10 }}>
                <ScrollView style={styles.sectionsContainer}>
                    ...
                    <Text style={styles.subtitle}>Clear data</Text>
                    <View style={styles.section}>
                        <Text style={styles.text}>{texts[1]}
                            <Text style={[styles.text, styles.warning, { marginTop: 0 }]}> Clear data is a permanent option. Data won't be recoverable. Please consider exporting it first.</Text>
                        </Text>
                        ...
                        }} style={[styles.button, clearingData && { backgroundColor: 'red' }, dataCleared && { backgroundColor: 'green' }]}>
                            <Text style={styles.buttonText}>{!dataCleared && !clearingData ? 'Clear data' : clearingData ? 'Are you sure?' : 'Data cleared'}</Text>
                        </Pressable>
                    </View>
                    <Text style={styles.subtitle}>Export data</Text>
                    <View style={styles.section}>
                        <Text style={styles.text}>{texts[2]} <Text style={[styles.text, styles.warning, { marginTop: 0 }]}> You may be asked to create a new folder.</Text></Text>
                        <Pressable onPress={async () => {
                            if (dataExported) {
                        ...
                        }} style={[styles.button, dataExported && { backgroundColor: 'green' }]}>
                            <Text style={styles.buttonText}>{dataExported ? 'Data exported!' : 'Export data'}</Text>
                        </Pressable>
                    </View>
                    <Text style={styles.subtitle}>Import data</Text>
                    <View style={styles.section}>
                        <Text style={styles.text}>{texts[3]}<Text style={[styles.text, styles.warning, { marginTop: 0 }]}> This will erase your previous data.</Text></Text>
                        <Pressable onPress={async () => {
                            ...
                            style={[styles.button, importingData && { backgroundColor: 'red' }, dataImported && { backgroundColor: 'green' }]}>
                            <Text style={styles.buttonText}>{!dataImported && !importingData ? 'Import data' : importingData ? 'Are you sure?' : 'Data imported'}</Text>
                        </Pressable>
                    </View>
